        ...
        <CardContent className="pt-4 space-y-6">
          ...
          <div className="border-t border-orange-100 pt-4">
            ...
            <div className="space-y-3 max-h-64 overflow-y-auto pr-2">
              {history.length === 0 ? (
                <p className="text-sm text-slate-500 text-center py-2">还没有记录哦</p>
              ) : (
                history.map((item) => (
                  <div key={item.id} className="flex justify-between items-center bg-orange-50/50 p-3 rounded-lg">
                    <div>
